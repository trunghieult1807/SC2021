...
//   List<Project> get allKeyResult => _krList;
...
//   void addManyKeyResults(List<Project> kr_list) {
//     kr_list.forEach((kr) => this.addKeyResult(kr));
//   }
//
//   Project removeKeyResult(int krId) {
