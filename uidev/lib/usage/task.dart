...
class Task extends Item {
  ...
  bool _isDone;
  String _projectID;
  Task(String id, String title, String desc, int mode, String projectName, String projectID, String createdDate, DateTime deadline, bool isDone) : _mode = mode, _projectName = projectName, _projectID = projectID, _createdDate = createdDate, _deadline = deadline, _isDone = isDone , super(id, title, desc);
